  ...
  return (
    <Fragment>
      ...
      <main className="page_content about-page">
        ...
        />
        <PolicySection />
        <section className="pricing_section py-5 bg-light">
          <div className="container">
            <div className="heading_block text-center">
              ...
              <h2 className="heading_text mb-0">Best Plane for Business</h2>
            </div>
            <div className="pricing_toggle_btn text-center">
              ...
              >
                <span>
                  Billed Monthly <small>-10%</small>
                </span>
                <span>
                  Billed Yearly <small>-30%</small>
                </span>
              </button>
            </div>
                ...
                <div className={`pricing_block ${isActive ? "active" : ""}`}>
                  ...
                  <ul className="icon_list unordered_list_block">
                    ...
                    <li>
                      ...
                      <span className="icon_list_text">IT Consulting.</span>
                    </li>
                    <li>
                      <span className="icon_list_icon">
                        <i className="fa-regular fa-circle-check"></i>
                  ...
                  <Link href="/pricing" className="btn btn-light">
                    <span className="btn_label" data-text="Purchase Now">
                      Purchase Now
                    </span>
              ...
              <div className="col-lg-6">
                <div className={`pricing_block ${isActive ? "active" : ""}`}>
                  <div className="best_plan">
                    <Image src={offerBanner} alt="Best Offer" />
                  </div>
                  <div className="table_head">
                    <div className="pricing_price_value bg-primary-subtle text-primary">
                      <span className="pricing_monthly">
                        <del>$60</del> $54{" "}
                        <sub>
                          You'll Save <u>$6</u> Monthly
                        </sub>
                      </span>
                      <span className="pricing_annually">
                        <del>$720</del> $504{" "}
                        <sub>
                          You'll Save <u>$216</u> Annually
                        </sub>
                      </span>
                    </div>
                    <div className="pricing_block_title">
