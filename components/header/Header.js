                                  ...
                                  <div className="megamenu_widget">
                                    ...
                                    <ul className="icon_list unordered_list_block">
                                      ...
                                      <li>
                                        <Link
                                          onClick={ClickHandler}
                                          href="/service-single/Website-Development"
                                        >
                                          <span className="icon_list_text">
                                            Website Development
                                          </span>
                                      ...
                                      <li>
                                        <Link
                                          onClick={ClickHandler}
                                          href="/service-single/Change-Management-Solutions"
                                        >
                                          <span className="icon_list_text">
                                      ...
                                      <li>
                                        <Link
                                          onClick={ClickHandler}
                                          href="/service-single/UI-UX-Design-Services"
                                        >
                                          <span className="icon_list_text">
                                  ...
                                  <div className="megamenu_widget">
                                    ...
                                    <ul className="icon_list unordered_list_block">
                                      ...
                                      <li>
                                        <Link
                                          onClick={ClickHandler}
                                          href="/service-single/Audit-&-IT-Consulting-Services"
                                        >
                                          <span className="icon_list_text">
                                            Banks
                                          </span>
                                      ...
                                      <li>
                                        <Link
                                          onClick={ClickHandler}
                                          href="/service-single/Business Process Optimization"
                                        >
                                          <span className="icon_list_text">
                                            Logistics
                                          </span>
                                      ...
                                      <li>
                                        <Link
                                          onClick={ClickHandler}
                                          href="/service-single/Strategic-Planning-and-Executions"
                                        >
                                          <span className="icon_list_text">
                                            Industries
                                          </span>
