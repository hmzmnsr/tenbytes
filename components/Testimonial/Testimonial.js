...
const testimonial = [
    ...
    },
    {
        ...
        Des: "We've been partnering with TenBytes for several years, and they have consistently delivered exceptional results. From custom software development to cloud services integration, their solutions have helped us stay ahead of the competition and adapt to evolving market demands. Their team's expertise, reliability, and commitment to customer satisfaction make them our go-to IT partner.",
        Name: 'Michel johnson',
    ...
    },
    {
        ...
        tImg:tImg3,
        Title:'Fast Respond',
        Des: "Working with TenBytes was a seamless experience from start to finish. Their team took the time to understand our business goals and challenges, and they delivered a solution that addressed our needs perfectly. Their professionalism, expertise, and dedication to customer satisfaction were evident throughout the project. We look forward to working with TenBytes on future initiatives.",
        Name: 'Bohdan Maksym',
    ...
    },
    {
        ...
        tImg:tImg4,
        Title:'Amazing services',
        Des: "The team at TenBytes surpassed our expectations. Their meticulous project management and technical prowess were exceptional. They closely collaborated with us, ensuring a that not only met but exceeded our needs. We are thrilled with the outcome.",
        Name: 'Anatoliy Vasyl',
        sub:'Director of Marketing',
    }
]
                                ...
                                <div className="review_block pb-0" key={tsm}>
                                    ...
                                    <div className="review_admin">
                                        <div className="review_admin_image">
                                            <Image src={testimonial.tImg} alt="Roman Dymtro" />
                                        </div>
